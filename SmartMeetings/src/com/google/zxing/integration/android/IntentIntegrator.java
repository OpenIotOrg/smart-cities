...
public class IntentIntegrator {
	...
	public void setTargetApplications(
			final Collection<String> targetApplications) {
	...
	public AlertDialog initiateScan(
		...
		intentScan.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
	...
	private AlertDialog showDownloadDialog() {
		...
		downloadDialog.setNegativeButton(this.buttonNo,
				new DialogInterface.OnClickListener() {
					@Override
					public void onClick(final DialogInterface dialogInterface,
							final int i) {
	 ...
	 */
	public AlertDialog shareText(final CharSequence text) {
	...
	private static Collection<String> list(final String... values) {
